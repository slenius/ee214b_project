function d = get_time_constants(d,c )
    ...
    d.A = 1 + d.m2.gm * parallel_r(d.r_2, d.m2.ro);
    d.B = d.m1.gm * d.r_1;
    ...
    d.t_in.r = 1 / (d.m1.gm);
    d.t_in.c = c.c_d + d.mb1.cdd + d.m1.csb + d.m2.cgs + (d.m1.cgs + d.m2.cgd + d.c_f);
    
    d.t_v.r = parallel_r(d.r_2, d.m2.ro);
    d.t_v.c = (d.m1.cgs + d.m2.cgd + d.c_f) + d.m2.cdb;
