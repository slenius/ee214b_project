function d = get_time_constants(d,c )
    ...
    d.t_in.r = 1 / (d.m1.gm * (1 + d.m5.gm * d.r_rgc));
    d.t_in.c = c.c_d + d.m1.cdd  + d.m1.css + d.mb1.cdd + d.m5.cgs + d.m5.cgd*(1+d.m5.gm * d.r_rgc);
    
    d.t_v.r = d.r_rgc;
    d.t_v.c = d.m1.cgg + d.m5.cdb;
    
    d.t_x.r = parallel_r(d.r_1, d.r_f);
    d.t_x.c = d.m1.cdd + d.m2.cgg + d.c_f;
    ...
    d.poles_w = -1 .* [d.t_in.w d.t_v.w d.t_w.w d.t_x.w d.t_y.w d.t_o.w];
