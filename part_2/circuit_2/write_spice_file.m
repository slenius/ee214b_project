...
fprintf(f, 'rgc n_vdd n_v   %0.1f\n', d.r_rgc);
fprintf(f, 'rf  n_ox  n_x   %0.1f\n', d.r_f);

fprintf(f, '\n');
fprintf(f, 'cl        n_o   0   %0.1ff\n', c.c_l*1e15);
fprintf(f, 'cd        n_i   0   %0.1ff\n', c.c_d*1e15);
fprintf(f, 'cf        n_ox  n_x %0.1ff\n', d.c_f*1e15);
fprintf(f, 'c_magic_0 n_z   0   1.0\n');
fprintf(f, 'c_magic_1 n_b   0   1.0\n');

fprintf(f, '\n');
fprintf(f, 'm1    n_x   n_v   n_i   0     nmos214       w=%0.1fu l=%0.2fu\n', d.m1.w, d.m1.l);
...
fprintf(f, 'm5    n_v   n_i   0     0     nmos214       w=%0.1fu l=%0.2fu\n', d.m5.w, d.m5.l);
