...
m.w = m.id / lookup(data, 'ID_W', 'GM_ID', m.gm_id, 'L', m.l, 'VDS', m.vds, 'VSB', m.vsb, 'VGS', m.vsb:0.01:1.8);
...
m.cgg = m.gm / m.wt;
m.cgd = m.cgg * lookup(data, 'CGD_CGG', 'GM_ID', m.gm_id, 'L', m.l, 'VDS', m.vds, 'VSB', m.vsb, 'VGS', m.vsb:0.01:1.8);
m.cdd = m.cgg * lookup(data, 'CDD_CGG', 'GM_ID', m.gm_id, 'L', m.l, 'VDS', m.vds, 'VSB', m.vsb, 'VGS', m.vsb:0.01:1.8);
m.css = m.cgg * lookup(data, 'CSS_CGG', 'GM_ID', m.gm_id, 'L', m.l, 'VDS', m.vds, 'VSB', m.vsb, 'VGS', m.vsb:0.01:1.8);
m.cdb = m.cdd - m.cgd;
m.cgs = m.cgg - m.cgd;
